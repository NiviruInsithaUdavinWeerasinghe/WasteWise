                  ...
                  <div className="flex justify-between items-start mb-4 px-1">
                    ...
                    {deliveryFee > 0 && (
                      <div className="text-right">
                        <div className="text-industrial-500 text-[10px] font-bold decoration-industrial-700">
                          Base: LKR {amount?.toLocaleString()}
                        </div>
                        <div className="text-nature-500 text-[10px] font-bold">
                          Delivery: LKR {deliveryFee?.toLocaleString()}
                        </div>
                      </div>
                    )}
                  </div>

                  {/* Beautiful Error Popup for Logistics */}
                  {logisticsError && (
                    <motion.div
                    ...
                    >
                      ...
                      <div>
                        <p className="text-xs font-bold text-red-400">Logistics Service Notice</p>
                        <p className="text-[10px] text-red-400/80 leading-tight mt-0.5">{logisticsError}</p>
                      </div>
                    </motion.div>
                  )}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                      {isProcessing ? (
                        ...
                        `Confirm & Pay LKR ${(amount + deliveryFee)?.toLocaleString()}`
                      )}
                    </button>
                  </form>
                </>
